...
- 📋 **v1.3 ML Risk Scoring** — Phase 5 (planned)
...
### v1.3 ML Risk Scoring (Planned)

**Milestone Goal:** Score transactions with XGBoost (p99 < 100ms SLA), with Redis feature lookup and fallback on timeout, publishing scored events downstream.
...
- [x] 05-03-PLAN.md — Docker Compose containerization, E2E tests, human UAT
