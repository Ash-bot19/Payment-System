...
Reference full template: `D:/Github/Payment System/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Github/Payment System/.claude/get-shit-done/templates/state.md`.
